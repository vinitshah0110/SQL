...
select cte.student_id, student_name, cte.subject_name, count(Examinations.subject_name) as 'attended_exams'
from cte left join Examinations
on cte.student_id = Examinations.student_id and cte.subject_name = Examinations.subject_name
group by cte.student_id, student_name, cte.subject_name
order by 1,3;